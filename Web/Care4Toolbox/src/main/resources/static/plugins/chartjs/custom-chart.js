...
$(function () {
	...
	var myChart = new Chart(ctx, {
		type: 'line',
		data: {
			labels: ['2010', '2011', '2012', '2013', '2014', '2018', '2019'],
			type: 'line',
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			datasets: [
				{
					data: [45, 25, 20, 10],
					backgroundColor: ['#564ec1', '#04cad0', '#ff9900', '#f5334f'],
					hoverBackgroundColor: ['#564ec1', '#04cad0', '#ff9900', '#f5334f'],
				},
			],
		...
		data: {
			...
			datasets: [
				...
				},
				{
					label: 'Page-views',
					data: [
						5, 3, 9, 6, 5, 9, 7, 3, 5, 2, 5, 3, 9, 6, 5, 9, 7, 3, 5, 2, 7, 10,
					],
