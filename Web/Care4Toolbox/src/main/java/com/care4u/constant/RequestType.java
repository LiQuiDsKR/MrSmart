...
public enum RequestType {
    ...
    ,DATA_TYPE_EXCEPTION, DATA_SEMANTIC_EXCEPTION, UNKNOWN_EXCEPTION, TAG_LIST_BY_TAG_MACADDRESS, TAG_LIST_BY_TOOLBOX_TOOL_LABEL_QRCODE, TAG_LIST_BY_TOOL_AND_TOOLBOX_ID, TOOLBOX_TOOL_LABEL_AVAILABLE, TAG_AVAILABLE
}
