...
class RentalRequestToolApproveAdapter(
    private var items : MutableList<RentalRequestToolApproveFormSelectedDto>
) : RecyclerView.Adapter<RentalRequestToolApproveAdapter.RentalRequestToolApproveViewHolder>() {

    inner class RentalRequestToolApproveViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
     ...
     * simply inflate.
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RentalRequestToolApproveViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_rentalrequesttool, parent, false)
        return RentalRequestToolApproveViewHolder(itemView)
    }
     ...
     * 2. addEventListener
     */
    override fun onBindViewHolder(holder: RentalRequestToolApproveViewHolder, position: Int) {
