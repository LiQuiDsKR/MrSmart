...
@Getter @Setter
@ToString
public class RentalRequestSheetApproveFormDto {
	
	@NotNull(message="시트 정보는 필수 입력값입니다.")
	@Min(value=1,message="시트 정보는 필수 입력값입니다.")
	private Long id;
	...
	@Min(value=1,message="승인자 정보는 필수 입력값입니다.")
	...
	private List<RentalRequestToolApproveFormDto> toolList;
