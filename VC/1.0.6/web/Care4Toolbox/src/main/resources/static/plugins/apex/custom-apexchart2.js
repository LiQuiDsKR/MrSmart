...
$(function () {
	...
	var spline_chart = new ApexCharts(
	...
	var line_column_chart = new ApexCharts(
	...
	var candlestick_chart = new ApexCharts(
	...
	var scatter_chart = new ApexCharts(
	...
	var radial_bar_chart = new ApexCharts(
	...
	var mixed_options = {
		...
		xaxis: {
			categories: [2009, 2010, 2011, 2012, 2013, 2014, 2018, 2016],
		},
		yaxis: [
			{
				axisTicks: {
	...
	var mixed_chart = new ApexCharts(
