...
$(function () {
	...
	var area2_Chart = new ApexCharts(
	...
	var area3_Chart = new ApexCharts(
	...
	var area4_Chart = new ApexCharts(
	...
	var area5_Chart = new ApexCharts(
		document.querySelector('#apex_area5-chart'),
		area5_options
	);
	area5_Chart.render();
	...
	var area6_Chart = new ApexCharts(
	...
	var column_options = {
		series: [
			{
				name: 'Net Profit1',
				data: [60, 55, 57, 56, 61, 58, 63, 60, 66, 50, 40],
			},
			{
				name: 'Revenue',
	...
	var column2_chart = new ApexCharts(
	...
	var column3_chart = new ApexCharts(
		document.querySelector('#apex_column3-chart'),
		column3_options
	);
	...
	var column4_chart = new ApexCharts(
		document.querySelector('#apex_column4-chart'),
		column4_options
	);
		...
		series: [
			{
				name: 'Inflation',
				data: [
					4.0, 3.4, 7.0, 5.5, 6.7, 4.6, 3.2, 4.6, 7.0, 5.5, 6.7, 10.9, 4.0, 3.4,
					7.0, 5.5, 6.7, 4.6, 3.2, 4.6, 7.0, 5.5, 6.7, 11.2, 4.0, 3.4, 7.0, 5.5,
					6.7, 4.6, 3.2, 4.6, 7.0, 5.5, 6.7, 10.2,
				],
			},
		],
		chart: {
	...
	var column5_chart = new ApexCharts(
		document.querySelector('#apex_column5-chart'),
		column5_options
	);
		...
		series: [
			{
				name: 'Inflation',
				data: [
					4.0, 3.4, 7.0, 5.5, 6.7, 4.6, 3.2, 4.6, 7.0, 5.5, 6.7, 8.9, 4.0, 3.4,
					7.0, 5.5, 6.7, 4.6, 3.2, 4.6, 7.0, 5.5, 6.7, 9.2, 4.0, 3.4,
				],
			},
		],
		chart: {
	...
	var column6_chart = new ApexCharts(
	...
	var column7_chart = new ApexCharts(
	...
	var column8_chart = new ApexCharts(
	...
	var column9_chart = new ApexCharts(
	...
	var column10_chart = new ApexCharts(
	...
	var line2_Chart = new ApexCharts(
	...
	var line3_chart = new ApexCharts(
		document.querySelector('#apex_line3-chart'),
		line3_options
	);
	line3_chart.render();
	...
	var line4_chart = new ApexCharts(
		document.querySelector('#apex_line4-chart'),
		line4_options
	);
	line4_chart.render();
	...
	var line5_Chart = new ApexCharts(
		document.querySelector('#apex_line5-chart'),
		line5_options
	);
	line5_Chart.render();
	...
	var radar_options = {
		...
		xaxis: {
			categories: ['2014', '2018', '2019', '2020', '2021', '2022'],
		},
		yaxis: {
			tickAmount: 4,
		},
	...
	var radar_chart = new ApexCharts(
		document.querySelector('#apex_radar-chart'),
		radar_options
	);
	radar_chart.render();
	...
	var bar_chart = new ApexCharts(
		document.querySelector('#apex_bar-chart'),
		bar_options
	);
	bar_chart.render();
	...
	var pie_chart = new ApexCharts(
		document.querySelector('#apex_pie-chart'),
		pie_options
	);
	pie_chart.render();
	...
	var pie2_options = {
		...
		labels: [
			'Facebook <span class="bold">$15</span>',
			'Twitter  <span class="bold">$15</span>',
			'Pinterest  <span class="bold">$15</span>',
			'Instagram  <span class="bold">$15</span>',
		],
		responsive: [
			{
				breakpoint: 1900,
